...
#define PORT_RTS1 PORTD
#define PIN_RTS1 PD6

#define RTS1_INIT        \
	DDR(PORT_RTS1) |= _BV( PIN_RTS1 ); \
	PORT_RTS1 &= ~( _BV(PIN_RTS1 ) );
...
void uart_init(unsigned int baudrate)
{
	...
	//mine (even parity)
	UCSRC |= _BV( UPM1 ) | _BV( UPM0 );//this configuration is for odd parity, but produces output of even parity
	//8 data bits
...
void uart1_init(unsigned int baudrate)
{
	...
	//mine (even parity)
	UCSR1C |= _BV( UPM11 ) | _BV( UPM10 );//this configuration is for odd parity, but produces output of even parity
	//8 data bits
