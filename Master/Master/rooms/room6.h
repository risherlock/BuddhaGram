...
void playScript(){	
		...
		SlaveCtrlAPI::lightGradualWrite (LIGHT_CONTROLLER, KANYA_FOCUS_LIGHT, 30, 8000);
		...
		SlaveCtrlAPI::lightGradualWrite (LIGHT_CONTROLLER, KANYA_FOCUS_LIGHT, 0, 5000);
		SlaveCtrlAPI::servoPosWrite(KANYA, NECK_SERVO, KANYA_NECK_RIGHT_POS);
		SlaveCtrlAPI::pneumaticWrite(KANYA, KANYA_WAIST_PNEUMATIC, OFF);
