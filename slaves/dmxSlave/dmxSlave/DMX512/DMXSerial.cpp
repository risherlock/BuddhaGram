...
//uart1->to slaves
//uart0->to super master
#define DMX_USE_UART1 1

#include "DMXSerial.h"
#include <avr/interrupt.h>

#if !defined(DMX_USE_UART1) && defined(__AVR_ATmega1284__)
...
#elif defined(DMX_USE_UART1) && defined(__AVR_ATmega1284__)
...
volatile unsigned int  _dmxMaxChannel = 15;	 // the last channel used for sending (1..32).
...
//Displays the binary equivalent of DMX channel
void DMXindicator(uint8_t i);
